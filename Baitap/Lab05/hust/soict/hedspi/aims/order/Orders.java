...
public class Orders{
	...
	public void printOrders(Orders o){
		...
		int i;
		for (i=0;i<qtyDVDOrdered;i++){
			System.out.println("DVD - " + itemsDVDOdered[i].getTitle() + " Cost - " + itemsDVDOdered[i].getCost());
		}
		for (i=0;i<qtyCDOrdered;i++){
			System.out.println("CD - " + itemsCDOdered[i].getTitle() + " Cost - " + itemsCDOdered[i].getCost());
		}
	}

	public DigitalVideoDisc getALuckyItem(){
		int rand = (int)(Math.random());
		return itemsDVDOdered[rand];
	}

	public void printOrdersLucky(Orders o, String title){
		System.out.println("Order " + nbOrders);
		System.out.print("Date: ");
		date.printCur(date);
		System.out.println("Ordered items: ");
		int i;
		for (i=0;i<qtyDVDOrdered;i++){
			if (itemsDVDOdered[i].search(title) == true)
				System.out.println("DVD - " + itemsDVDOdered[i].getTitle() + " Cost - 0");
			else
				System.out.println("DVD - " + itemsDVDOdered[i].getTitle() + " Cost - " + itemsDVDOdered[i].getCost());
		}
		for (i=0;i<qtyCDOrdered;i++){
